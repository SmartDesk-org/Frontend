...
// import FeaturesPage from "./pages/FooterComponents/FeaturesPage";
        ...
        <Route element={<MainLayout />}>
          ...
          <Route path="/infrastructure" element={
            <ProductTemplate
              ...
              features={[
                { title: "Edge Caching", desc: "Content delivered from the node closest to your office." },
                { title: "Auto-Scaling", desc: "Resources scale up/down based on real-time booking demand." },
                { title: "Disaster Recovery", desc: "Automated failover to secondary regions in under 30 seconds." }
              ]} 
            />
          } />
          ...
          <Route path="/integrations" element={
            <ProductTemplate
              ...
              features={[
                { title: "Slack & Teams", desc: "Book desks directly from your chat apps." },
                { title: "HRIS Sync", desc: "Sync employee data from Workday, BambooHR, and Rippling." },
                { title: "Calendar", desc: "Two-way sync with Google Calendar and Outlook." }
              ]} 
            />
          } />
          ...
          <Route path="/enterprise" element={
            <ProductTemplate 
              ...
              features={[
                { title: "SAML/SSO", desc: "Enforce security policies with Okta, Azure AD, or OneLogin." },
                { title: "Audit Logs", desc: "Track every booking, cancellation, and admin action." },
                { title: "Dedicated Support", desc: "24/7 priority support with a dedicated Success Manager." }
              ]} 
            />
          } />
          ...
          <Route path="/docs" element={
            <ProductTemplate 
               ...
               features={[
                 ...
                 { title: "SDKs", desc: "Libraries for Node.js, Python, and Go." },
          ...
          <Route path="/api" element={
             <ProductTemplate 
               ...
               features={[
                 { title: "Authentication", desc: "Bearer Token authentication." },
                 { title: "Rate Limits", desc: "1000 req/min for Enterprise." },
                 { title: "Interactive Console", desc: "Test endpoints directly in browser." }
               ]}
            />
          } />
          ...
          <Route path="/opensource" element={
             <ProductTemplate 
               ...
               features={[
                 { title: "React Components", desc: "Our UI library is public." },
          ...
          {/* --- LEGAL ROUTES --- */}
          <Route path="/privacy" element={<LegalTemplate title="Privacy Policy" lastUpdated="Jan 2026" />} />
          <Route path="/dpa" element={<LegalTemplate title="Data Processing Addendum" lastUpdated="Dec 2025" />} />
          <Route path="/subprocessors" element={<LegalTemplate title="List of Subprocessors" lastUpdated="Jan 2026" />} />
          <Route path="/security" element={<LegalTemplate title="Security Measures" lastUpdated="Jan 2026" />} />
        </Route>
